...
import { commentary } from '../config/schema.js';

import { matchIdParamSchema } from '../validations/matches.js';

import { listCommentaryQuerySchema, createCommentarySchema } from "../validations/commentary.js";
...
commentaryRouter.post('/', async (req, res) => {
    ...
    try {
        ...
        // here we happens to know to specific users about their specific matches
